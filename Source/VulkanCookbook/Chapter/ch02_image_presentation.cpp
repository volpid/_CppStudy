    ...
    std::vector<VkImage>& swapchainImages)
{
    ...
    if (SelectFormatOfSwapchainImage(physicalDevice, presentationSurface, {VK_FORMAT_B8G8R8A8_UNORM, VK_COLOR_SPACE_SRGB_NONLINEAR_KHR}, imageFormat, imageColorSpace) == false)
    {
        return false;
    }
