...
//----------------------------------------------------------------
#if !defined(EXPORT_VULKAN_FUNTION)
#define EXPORT_VULKAN_FUNTION(function)
#endif /**/

EXPORT_VULKAN_FUNTION(vkGetInstanceProcAddr)

#undef EXPORT_VULKAN_FUNTION
...
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(vkDestroySurfaceKHR, VK_KHR_SURFACE_EXTENSION_NAME)
    ...
    INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(vkCreateXcbSurfaceKHR, VK_KHR_XCV_SURFACE_EXTENSION_NAME)
