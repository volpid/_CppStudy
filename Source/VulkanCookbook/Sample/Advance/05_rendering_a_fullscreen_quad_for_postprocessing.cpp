...
//----------------------------------------------------------------
// SampleAdvance05 : rendering a fullscreen quad for postprocessing
//----------------------------------------------------------------
class SampleAdvance05 : public VulkanSample
{
public:
...
//VULKAN_SAMPLE_FRAMEWORK("05_rendering_a_fullscreen_quad_for_postprocessing", 50, 25, 800, 600, SampleAdvance05);

//----------------------------------------------------------------
bool SampleAdvance05::Initialize(WindowParameters parameters)
{   
    ...
    if (GetBinaryFileContent("..\\..\\Source\\VulkanCookbook\\Shader\\Advance\\05_shader.vert.spv", vertexShaderSpirv) == false)
    {
        return false;
    }
    ...
    if (GetBinaryFileContent("..\\..\\Source\\VulkanCookbook\\Shader\\Advance\\05_shader.frag.spv", fragmentShaderSpirv) == false)
    {
        return false;
    }
...
bool SampleAdvance05::Draw(void)
{
...
bool SampleAdvance05::Resize(void)
{
