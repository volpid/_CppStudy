...
//----------------------------------------------------------------
// SampleChapter09 : using geometry shader
//----------------------------------------------------------------
class SampleChapter09 : public VulkanSample
{
public:
...
//VULKAN_SAMPLE_FRAMEWORK("09_using_geometry_shaders", 50, 25, 800, 600, SampleChapter09);

//----------------------------------------------------------------
bool SampleChapter09::Initialize(WindowParameters parameters)
{   
    ...
    if (GetBinaryFileContent("..\\..\\Source\\VulkanCookbook\\Shader\\Basic\\09_shader.vert.spv", vertexShaderSpirv) == false)
    {
        return false;
    }
    ...
    if (GetBinaryFileContent("..\\..\\Source\\VulkanCookbook\\Shader\\Basic\\09_shader.geom.spv", geometryShaderSpirv) == false)
    {
        return false;
    }
    ...
    if (GetBinaryFileContent("..\\..\\Source\\VulkanCookbook\\Shader\\Basic\\09_shader.frag.spv", fragmentShaderSpirv) == false)
    {
        return false;
    }
...
bool SampleChapter09::Draw(void)
{
...
bool SampleChapter09::Resize(void)
{
