...
//----------------------------------------------------------------
// SampleLighting02 : rendering a geometry with fragment specular lighting
//----------------------------------------------------------------
class SampleLighting02 : public VulkanSample
{
public:
...
//VULKAN_SAMPLE_FRAMEWORK("02_rendering_a_geometry_with_fragment_specular_lighting", 50, 25, 800, 600, SampleLighting02);

//----------------------------------------------------------------
bool SampleLighting02::Initialize(WindowParameters parameters)
{   
    ...
    if (GetBinaryFileContent("..\\..\\Source\\VulkanCookbook\\Shader\\Lighting\\02_shader.vert.spv", vertexShaderSpirv) == false)
    {
        return false;
    }
    ...
    if (GetBinaryFileContent("..\\..\\Source\\VulkanCookbook\\Shader\\Lighting\\02_shader.frag.spv", fragmentShaderSpirv) == false)
    {
        return false;
    }
...
bool SampleLighting02::Draw(void)
{
...
bool SampleLighting02::Resize(void)
{
...
void SampleLighting02::OnMouseEvent(void)
{
    _UpdateUniformbuffer(false);
}

bool SampleLighting02::_UpdateUniformbuffer(bool force)
{
